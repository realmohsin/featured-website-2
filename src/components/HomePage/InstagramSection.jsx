  ...
  return (
    <section className={classes.instagramSection}>
      <StaticImage
        ...
        alt="background"
      />
      <Container data-testid="instagram-container">
        <h2 className={classes.instagramTitle}>Romano Law Instagram</h2>
        <Grid container className={classes.instagramGrid} data-testid="instagram-grid">
          {data.allFile.nodes.map((node, index) => (
            <Grid key={index} item className={classes.gridItem} xs={12} sm={6} md={4}>
              <GatsbyImage
